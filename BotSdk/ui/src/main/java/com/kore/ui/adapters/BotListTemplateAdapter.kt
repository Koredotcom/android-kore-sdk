...
class BotListTemplateAdapter(
    ...
    class BotListViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val botItemTitle: TextView
        val botItemSubtitle: TextView
        val botItemButton: TextView
        val botItemRoot: RelativeLayout
        val botListItemImage: ImageView

        init {
            botItemTitle = view.findViewById(R.id.bot_list_item_title)
            botItemSubtitle = view.findViewById(R.id.bot_list_item_subtitle)
            botItemButton = view.findViewById(R.id.bot_list_item_button)
            botItemRoot = view.findViewById(R.id.bot_list_item_root);
    ...
    override fun onBindViewHolder(holder: BotListViewHolder, position: Int) {
        ...
        val title = listElementsMap[BotResponseConstants.KEY_TITLE] as String
            ...
            try {
                ...
                when (btn[BotResponseConstants.TYPE]) {
                    ...
                    BotResponseConstants.WEB_URL -> {
                        ...
                        actionEvent(
                            BotChatEvent.SendMessage(title, btn[BotResponseConstants.PAYLOAD] as String)
                        )
                    }
                }
            } catch (e: Exception) {
        ...
        holder.botItemSubtitle.text = subTitle
