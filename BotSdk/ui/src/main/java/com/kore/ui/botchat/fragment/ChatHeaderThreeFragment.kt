...
class ChatHeaderThreeFragment(private val onActionEvent: (event: UserActionEvent) -> Unit) : Fragment() {
    lateinit var binding: BotHeader3Binding
