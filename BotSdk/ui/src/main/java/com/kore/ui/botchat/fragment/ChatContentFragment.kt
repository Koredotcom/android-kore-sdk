...
class ChatContentFragment : Fragment(), QuickRepliesClickListener {
    ...
    fun showTypingIndicator(icon: String?, enable: Boolean) {
    ...
    fun addMessagesToAdapter(messages: List<BaseBotMessage>, isHistory: Boolean) {
        binding.swipeContainerChat.isRefreshing = false
    ...
    fun getAdapterCount(): Int = chatAdapter.itemCount
