    ...
    override fun <Binding : ViewBinding> bind(binding: Binding) {
        ...
        childBinding.apply {
            ...
            if (rightDrawable != null && sharedPreferences != null) {
                rightDrawable.setColor(sharedPreferences.getString(BUTTON_ACTIVE_BG_COLOR, "#ffffff")!!.toColorInt())
                rightDrawable.setStroke(
                    1.dpToPx(root.context),
                    sharedPreferences.getString(WIDGET_BORDER_COLOR, "#3942f6")!!.toColorInt()
                )
                root.background = rightDrawable
                title.setTextColor(sharedPreferences.getString(BUTTON_ACTIVE_TXT_COLOR, "#505968")!!.toColorInt())
            }
        }
    }
}