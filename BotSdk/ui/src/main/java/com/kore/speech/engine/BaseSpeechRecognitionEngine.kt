...
import com.kore.speech.DelayedOperation
import com.kore.speech.GoogleVoiceTypingDisabledException
import com.kore.speech.Logger
import com.kore.speech.SpeechDelegate
import com.kore.speech.SpeechRecognitionException
...
class BaseSpeechRecognitionEngine : SpeechRecognitionEngine {
    ...
    private var mProgressView: com.kore.speech.ui.SpeechProgressView? = null
    ...
    override fun startListening(progressView: com.kore.speech.ui.SpeechProgressView?, delegate: SpeechDelegate) {
