...
class RotatingAnimator(private val bars: List<com.kore.speech.ui.SpeechBar>, private val centerX: Int, private val centerY: Int) : BarParamsAnimator {
     ...
     */
    private fun rotate(bar: com.kore.speech.ui.SpeechBar, degrees: Double, startPosition: Point) {
