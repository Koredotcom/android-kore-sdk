...
class IdleAnimator(private val bars: List<com.kore.speech.ui.SpeechBar>, private val floatingAmplitude: Int) : BarParamsAnimator {
    ...
    private fun update(bars: List<com.kore.speech.ui.SpeechBar>) {
    ...
    private fun updateCirclePosition(bar: com.kore.speech.ui.SpeechBar, delta: Long, num: Int) {
