package com.kore.common.speech.ui;
...
import com.kore.common.speech.ui.animators.BarParamsAnimator;
import com.kore.common.speech.ui.animators.IdleAnimator;
import com.kore.common.speech.ui.animators.RmsAnimator;
import com.kore.common.speech.ui.animators.RotatingAnimator;
import com.kore.common.speech.ui.animators.TransformAnimator;
...
public class SpeechProgressView extends View {
    ...
    private int[] barColors = {Color.parseColor("#ffffff"), Color.parseColor("#ffffff"), Color.parseColor("#ffffff"), Color.parseColor("#ffffff"), Color.parseColor("#ffffff")};

    private int[] barMaxHeights = {10, 20, 30, 20, 10};
    ...
    private void initBars() {
        ...
        int firstCirclePosition = getMeasuredWidth() / 2 - 2 * spacing - 4 * radius;
