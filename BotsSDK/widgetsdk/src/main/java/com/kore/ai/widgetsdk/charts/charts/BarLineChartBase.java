...
import static com.kore.ai.widgetsdk.charts.components.Legend.LegendVerticalAlignment.BOTTOM;
import static com.kore.ai.widgetsdk.charts.components.Legend.LegendVerticalAlignment.TOP;
...
import com.kore.ai.widgetsdk.charts.highlight.ChartHighlighter;
...
import com.kore.ai.widgetsdk.charts.jobs.AnimatedMoveViewJob;
import com.kore.ai.widgetsdk.charts.jobs.AnimatedZoomJob;
import com.kore.ai.widgetsdk.charts.jobs.MoveViewJob;
import com.kore.ai.widgetsdk.charts.jobs.ZoomJob;
import com.kore.ai.widgetsdk.charts.listener.BarLineChartTouchListener;
import com.kore.ai.widgetsdk.charts.listener.OnDrawListener;
import com.kore.ai.widgetsdk.charts.renderer.XAxisRenderer;
import com.kore.ai.widgetsdk.charts.renderer.YAxisRenderer;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public Entry getEntryByTouchPoint(float x, float y) {
        ...
        return h != null ? ((BarLineScatterCandleBubbleData)this.mData).getEntryForHighlight(h) : null;
    }
