...
public abstract class DataSet<T extends Entry> extends BaseDataSet<T> {
    ...
    public abstract com.kore.ai.widgetsdk.charts.data.DataSet<T> copy();

    protected void copy(com.kore.ai.widgetsdk.charts.data.DataSet dataSet) {
        super.copy(dataSet);
    }
    ...
    public T getEntryForXValue(float xValue, float closestToY) {
        return this.getEntryForXValue(xValue, closestToY, com.kore.ai.widgetsdk.charts.data.DataSet.Rounding.CLOSEST);
    }
    ...
    public int getEntryIndex(float xValue, float closestToY, com.kore.ai.widgetsdk.charts.data.DataSet.Rounding rounding) {
        if (this.mValues != null && !this.mValues.isEmpty()) {
            ...
            if (closest != -1) {
                ...
                } else if (rounding == com.kore.ai.widgetsdk.charts.data.DataSet.Rounding.DOWN && closestXValue > xValue && closest > 0) {
                    --closest;
                }
