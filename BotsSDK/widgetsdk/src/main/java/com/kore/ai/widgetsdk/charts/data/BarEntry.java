...
import com.kore.ai.widgetsdk.charts.highlight.Range;
...
public class BarEntry extends Entry {
    ...
    public com.kore.ai.widgetsdk.charts.data.BarEntry copy() {
        com.kore.ai.widgetsdk.charts.data.BarEntry copied = new com.kore.ai.widgetsdk.charts.data.BarEntry(this.getX(), this.getY(), this.getData());
