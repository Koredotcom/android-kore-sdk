...
public class Entry extends BaseEntry implements Parcelable {
    ...
    public com.kore.ai.widgetsdk.charts.data.Entry copy() {
        com.kore.ai.widgetsdk.charts.data.Entry e = new com.kore.ai.widgetsdk.charts.data.Entry(this.x, this.getY(), this.getData());
        return e;
    }
