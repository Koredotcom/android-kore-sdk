...
import com.kore.ai.widgetsdk.charts.formatter.DefaultFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<com.kore.ai.widgetsdk.charts.data.Entry> implements ILineDataSet {
    private Mode mMode;
