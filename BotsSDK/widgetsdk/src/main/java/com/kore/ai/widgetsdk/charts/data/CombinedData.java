...
public class CombinedData extends BarLineScatterCandleBubbleData<IBarLineScatterCandleBubbleDataSet<? extends Entry>> {
    ...
    private com.kore.ai.widgetsdk.charts.data.BarData mBarData;
    private ScatterData mScatterData;
    private com.kore.ai.widgetsdk.charts.data.CandleData mCandleData;
    private com.kore.ai.widgetsdk.charts.data.BubbleData mBubbleData;
    ...
    public void setData(com.kore.ai.widgetsdk.charts.data.BarData data) {
        this.mBarData = data;
        this.notifyDataChanged();
    }
    ...
    public void setData(com.kore.ai.widgetsdk.charts.data.CandleData data) {
        this.mCandleData = data;
        this.notifyDataChanged();
    }

    public void setData(com.kore.ai.widgetsdk.charts.data.BubbleData data) {
