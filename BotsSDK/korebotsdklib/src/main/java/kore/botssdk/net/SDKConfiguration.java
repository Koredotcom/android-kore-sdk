...
public class SDKConfiguration {
    ...
    public static class Client {
        ...
        public static String client_id = "cs-425112d3-284a-5f54-a8b6-ef2725e6b4fa";//"cs-96c4747a-bb79-58b0-9dca-0dcf6c6148cf";//"cs-dc0f84ac-4751-5293-b254-6a0a382ab08c";//"cs-a269ad0a-45ec-5b41-9950-18571e42a6a4";//"cs-5649368e-68bb-555a-8803-935f223db585";
        public static String client_secret = "yIN2I9oFGvkoX9kFOnoYdekQz8tW+hFy6pDBM2Qh9lw=";//"qc4c+FOpEo88m27BgECpcS/oC/CKDWa8u70ll0qr4MM=";//"MiFzNLLWTQZddj1HOmdM4iyePhQ+gED4jdUg88Ujh1Y=";//"kmZ7ck9wRxSVV2dNNwi2P3UZI3qacJgu7JL9AmZapS4=";//"AHSubkG09DRdcz9xlzxUXfrxyRx9V0Yhd+6SnXtjYe4=";
        public static String identity = "anilkumar.routhu@kore.com";
        public static String bot_name = "TacoBell Demo";//"Android test";//"NewTemplates";
        public static String bot_id = "st-7692453c-f1db-568e-aa15-d145780b0914";//"st-2e4c9eaf-070c-5b86-8020-add76f37e3a2";//"st-05303785-9992-526c-a83c-be3252fd478e";//"st-caecd28f-64ed-5224-a612-7a3d3a870aed";//"st-cc32974e-c7a2-52d1-83bf-c3dc2b2a9db3";
