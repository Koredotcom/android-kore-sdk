 ...
 */
public class BotSpeechSocketRestService extends RetrofitGsonSpiceService {
    ...
    protected String getServerUrl() {
        return SDKConfiguration.SpeechServer.SPEECH_SERVER_SOCKET_URL;
    }
    ...
    protected RestAdapter.Builder createRestAdapterBuilder() {
        ...
        builder.setErrorHandler(new KoreAuthErrorHandler(BotSpeechSocketRestService.this));
