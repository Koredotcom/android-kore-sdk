...
public class BotBankingRestBuilder {
    private static RestAPI serviceBot;

    private BotBankingRestBuilder(){}
...
//        client.interceptors().add(KoreRequestInterceptor.getInstance(mContext));
    ...
    private static GsonConverterFactory createConverter() {
        ...
        gsonBuilder.registerTypeAdapter(boolean.class, new BotBankingRestBuilder.BooleanDeserializer());
