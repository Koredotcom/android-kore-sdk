...
import com.kore.findlysdk.events.CancelEvent;
import com.kore.findlysdk.events.EntityEditEvent;
import com.kore.findlysdk.events.KoreEventCenter;
import com.kore.findlysdk.fragments.WidgetActionSheetFragment;
import com.kore.findlysdk.listners.VerticalListViewActionHelper;
import com.kore.findlysdk.models.BaseChartModel;
import com.kore.findlysdk.models.BotResponse;
import com.kore.findlysdk.models.CalEventsTemplateModel;
import com.kore.findlysdk.models.WCalEventsTemplateModel;
import com.kore.findlysdk.models.WTaskTemplateModel;
import com.kore.findlysdk.models.Widget;
import com.kore.findlysdk.models.WidgetListElementModel;
import com.kore.findlysdk.models.WidgetListModel;
import com.kore.findlysdk.utils.Constants;
import com.kore.findlysdk.utils.DialogCaller;
...
import static com.kore.findlysdk.adapters.ListWidgetAdapter.showEmailIntent;
...
public class WidgetSelectActionsAdapter extends RecyclerView.Adapter<WidgetSelectActionsAdapter.WidgetCancelViewHolder> {
    ...
    public WidgetCancelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(widgetDialogActivity.getContext()).inflate(R.layout.widget_cancel_findly_laout, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull WidgetCancelViewHolder holder, final int position) {
        ...
        if (model instanceof WTaskTemplateModel) {
            ...
            final Widget.Action act = ((Widget.Element) model).getActions().get(position);
            String text;
            ...
            final Widget.Button finalButton = button;
            holder.tv_actions.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    (widgetDialogActivity).dismiss();
        ...
        else if(model instanceof WidgetListModel)
        {
          ...
          //  return (actionList!=null&&ba!=null&&ba.getHeaderOptions()!=null&&ba.getHeaderOptions().getMenu()!=null)?ba.getHeaderOptions().getMenu().size():0;
            ...
            final Widget.Button finalButton = wL.getHeaderOptions().getMenu().get(position);
            holder.tv_actions.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    (widgetDialogActivity).dismiss();
        ...
        }else if(model instanceof BaseChartModel)
        {
            ...
            final Widget.Button finalButton = ba.getHeaderOptions().getMenu().get(position);
            holder.tv_actions.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    (widgetDialogActivity).dismiss();
