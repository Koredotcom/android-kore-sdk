...
import com.kore.findlysdk.view.viewUtils.CarouselItemViewHelper;
...
public class BotCarouselAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        final View carouselItemLayout = ownLayoutInflater.inflate(R.layout.carousel_item_findly_layout, container, false);
