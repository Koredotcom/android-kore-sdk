...
import com.kore.findlysdk.adapters.BotCarouselItemButtonAdapter;
...
public class CarouselItemView extends ViewGroup {
    ...
    private void init() {
        ...
        View inflatedView;
        inflatedView = ownLayoutInflater.inflate(R.layout.carousel_item_findly_layout, container, false);
