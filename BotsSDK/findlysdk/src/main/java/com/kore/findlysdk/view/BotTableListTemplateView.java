...
import com.kore.findlysdk.adapters.BotTableListTemlateAdapter;
...
public class BotTableListTemplateView extends LinearLayout {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.bot_table_list_template_findly_view, this, true);
