 ...
 */
public class KaSendBubbleFindlyLayout extends KaBaseBubbleFindlyLayout {

    public KaSendBubbleFindlyLayout(Context context) {
        super(context);
        init();
    }

    public KaSendBubbleFindlyLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public KaSendBubbleFindlyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public KaSendBubbleFindlyLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
