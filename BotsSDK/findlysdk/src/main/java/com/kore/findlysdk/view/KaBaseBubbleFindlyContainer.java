 ...
 */
public abstract class KaBaseBubbleFindlyContainer extends ViewGroup {

    protected int dp1;
    protected int BUBBLE_CONTENT_LAYOUT_WIDTH, BUBBLE_CONTENT_LAYOUT_HEIGHT;
    private boolean viewActive =true;

    public KaBaseBubbleFindlyContainer(Context context) {
        super(context);
    }

    public KaBaseBubbleFindlyContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public KaBaseBubbleFindlyContainer(Context context, AttributeSet attrs, int defStyleAttr) {
