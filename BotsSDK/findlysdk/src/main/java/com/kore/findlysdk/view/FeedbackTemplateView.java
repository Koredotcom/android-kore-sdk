...
import com.kore.findlysdk.fragments.FeedbackActionSheetFragment;
...
public class FeedbackTemplateView extends LinearLayout implements View.OnClickListener
{
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.feedback_template_findly_view, this, true);
