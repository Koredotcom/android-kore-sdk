...
//                    if (narratorModels != null){}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int fullWidthSpec = View.MeasureSpec.makeMeasureSpec(maxAllowedWidth, View.MeasureSpec.EXACTLY);
...
//        MeasureUtils.measure(botListViewTemplateView, wrapSpec, wrapSpec);
         ...
         * For PieChart
         */
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth - 40 * (int) dp1, View.MeasureSpec.EXACTLY);
         ...
         * For List View Templates
         */
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth - 70 * (int) dp1, View.MeasureSpec.EXACTLY);
...
//        childHeightSpec = MeasureSpec.makeMeasureSpec((int) (pieViewHeight), MeasureSpec.EXACTLY);
         ...
         */
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth - 30 * (int) dp1, View.MeasureSpec.EXACTLY);
