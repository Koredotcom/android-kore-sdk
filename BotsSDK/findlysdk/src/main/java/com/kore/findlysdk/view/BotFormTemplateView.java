...
import com.kore.findlysdk.adapters.BotFormTemplateAdapter;
...
public class BotFormTemplateView extends ViewGroup {
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.form_templete_findly_view, this, true);
