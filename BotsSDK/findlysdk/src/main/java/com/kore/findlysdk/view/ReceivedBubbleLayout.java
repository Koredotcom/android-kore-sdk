...
public class ReceivedBubbleLayout extends BaseBubbleLayout {
    ...
    protected void initializeBubbleContentDimen() {
        ...
        maxContentDimen[0] = BUBBLE_LEFT_BORDER + BUBBLE_LEFT_PROFILE_PIC_MARGIN_LEFT + BUBBLE_LEFT_PROFILE_PIC + BUBBLE_LEFT_PROFILE_PIC_MARGIN_RIGHT
                ...
                barChartView.getMeasuredWidth(),stackedBarChatView.getMeasuredWidth(),
        ...
        maxBubbleDimen[1] = BUBBLE_SEPARATION_DISTANCE + BUBBLE_TOP_BORDER + BUBBLE_CONTENT_TOP_MARGIN +
                ...
                +botButtonView.getMeasuredHeight() + botListTemplateView.getMeasuredHeight()+ BUBBLE_CONTENT_BOTTOM_MARGIN + BUBBLE_DOWN_BORDER;
        maxContentDimen[1] = BUBBLE_CONTENT_TOP_MARGIN + headerLayoutDimen[1] + textMediaDimen[1] + botCarouselView.getMeasuredHeight() + botButtonView.getMeasuredHeight() + botListTemplateView.getMeasuredHeight() + botPieChartView.getMeasuredHeight() +
                lineChartView.getMeasuredHeight()+barChartView.getMeasuredHeight()+stackedBarChatView.getMeasuredHeight()+BUBBLE_CONTENT_BOTTOM_MARGIN;
    }
...
//                    }*/
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) cpvSenderImageDimen, View.MeasureSpec.EXACTLY);
        childHeightSpec = View.MeasureSpec.makeMeasureSpec((int) cpvSenderImageDimen, View.MeasureSpec.EXACTLY);
         ...
         * For PieChart
         */
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth - 50 * (int)dp1, View.MeasureSpec.EXACTLY);
        childHeightSpec = View.MeasureSpec.makeMeasureSpec((int) (pieViewHeight), View.MeasureSpec.EXACTLY);
...
//        childHeightSpec = MeasureSpec.makeMeasureSpec((int) (tableHeight), MeasureSpec.EXACTLY);
        ...
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth - 50 * (int)dp1, View.MeasureSpec.EXACTLY);
        childHeightSpec = View.MeasureSpec.makeMeasureSpec((int) lineHeight, View.MeasureSpec.EXACTLY);
         ...
         * For CarouselView
         */
        childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) screenWidth, View.MeasureSpec.EXACTLY);
