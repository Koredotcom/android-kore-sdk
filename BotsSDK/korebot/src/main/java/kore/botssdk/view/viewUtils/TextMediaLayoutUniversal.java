 ...
 */
public class TextMediaLayoutUniversal extends ViewGroup {
...
//    final String TEXT_COLOR = "#000000";
    ...
    public TextMediaLayoutUniversal(Context context) {
        super(context);
        this.mContext = context;
        init();
    }
    boolean singleLine;
    public TextMediaLayoutUniversal(Context context, int linkTextColor,boolean singleLine) {
        super(context);
        this.mContext = context;
        this.linkTextColor = Color.parseColor(SDKConfiguration.BubbleColors.leftLinkColor);
    ...
    private void init() {
        ...
        if(singleLine) {
            botContentTextView.setSingleLine(true);
            botContentTextView.setEllipsize(TextUtils.TruncateAt.END);
        }
        else {

            botContentTextView.setInputType(InputType.TYPE_TEXT_FLAG_MULTI_LINE);
            botContentTextView.setSingleLine(false);
        }
