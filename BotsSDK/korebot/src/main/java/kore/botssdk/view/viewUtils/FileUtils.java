...
public class FileUtils {
    ...
    public static int getColorForFileType(String fileType){
        ...
        if(fileType.equalsIgnoreCase(EXT_PDF) || fileType.equalsIgnoreCase(EXT_PPT) || fileType.equalsIgnoreCase(EXT_PPTX))return Color.parseColor(COLOR_PDF_OR_PPTX);
        else if(fileType.equalsIgnoreCase(EXT_TXT) || fileType.equalsIgnoreCase(EXT_GIF) || fileType.equalsIgnoreCase(EXT_ICO)) return Color.parseColor(COLOR_GIF);
