...
public class CircularProfileViewWithBorder extends RoundedImageView {
    ...
    public CircularProfileViewWithBorder(Context context) {
        super(context);
        init(null, context);
    }

    public CircularProfileViewWithBorder(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, context);
    }

    public CircularProfileViewWithBorder(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public  void setIsBorder(boolean hasBorder) {
    ...
    private void drawBorder(Canvas canvas) {
        ...
        int centerX =  (value / 2);
        int centerY =  (value / 2);
        int radius =  (value / 2 - borderStrokeWidth);
