...
public class AdvanceListButtonAdapter extends RecyclerView.Adapter<AdvanceListButtonAdapter.ButtonViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ButtonViewHolder holder, int position) {
        ...
        if (isOptions) {
            ...
            if (position % 2 == 0) {
                gradientDrawable.setColor(Color.parseColor(sharedPreferences.getString(BotResponse.BUBBLE_RIGHT_BG_COLOR, "#3F51B5")));
                gradientDrawable.setStroke(1, Color.parseColor(sharedPreferences.getString(BotResponse.BUBBLE_RIGHT_BG_COLOR, "#3F51B5")));
                holder.tv.setTextColor(Color.parseColor(sharedPreferences.getString(BotResponse.BUBBLE_RIGHT_TEXT_COLOR, "#ffffff")));
            } else {
            ...
            holder.tv.setTextColor(Color.parseColor(sharedPreferences.getString(BotResponse.BUBBLE_RIGHT_BG_COLOR, "#3F51B5")));
        ...
        if (!StringUtils.isNullOrEmpty(btn.getIcon())) {
            ...
            try {
                ...
                if (imageData.contains(",")) {
                    ...
                    Glide.with(holder.ivBtnImage.getContext())
                            .load(btn.getIcon())
                            .transform(
