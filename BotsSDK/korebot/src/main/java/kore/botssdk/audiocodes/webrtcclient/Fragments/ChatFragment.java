...
public class ChatFragment extends BaseFragment implements FragmentLifecycle {
    ...
    private final CallBackHandler.ChatCallback chatCallback = new CallBackHandler.ChatCallback() {
        @Override
    ...
    private void initGui(View rootView) {
        EditText contact = rootView.findViewById(R.id.chat_contact_edittext);
        EditText message = rootView.findViewById(R.id.chat_message_edittext);
