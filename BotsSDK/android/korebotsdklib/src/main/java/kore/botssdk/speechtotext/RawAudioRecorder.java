...
//    AudioDataReceivedListener audioDataReceivedListener;
    ...
    private void prepareForRecording(){
        try {
            ...
            createRecorder(DEFAULT_AUDIO_SOURCE, DEFAULT_SAMPLE_RATE, bufferSize);
    ...
    public RawAudioRecorder(AudioDataReceivedListener audioDataReceivedListener) {
        this(DEFAULT_AUDIO_SOURCE, DEFAULT_SAMPLE_RATE);
        setAudioDataReceivedListener(audioDataReceivedListener);
