...
import com.kore.findlysdk.adapters.BotCarouselAdapter;
...
public class BotCarouselView extends ViewGroup {
    ...
    private void init() {
        ...
        View inflatedView = LayoutInflater.from(getContext()).inflate(R.layout.bot_carousel_findly_view, this, true);
