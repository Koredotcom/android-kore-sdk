...
import com.kore.findlysdk.adapters.ListWidgetAdapter;
import com.kore.findlysdk.events.EntityEditEvent;
import com.kore.findlysdk.events.KoreEventCenter;
import com.kore.findlysdk.fragments.ListWidgetActionSheetFragment;
...
import static com.kore.findlysdk.adapters.ListWidgetButtonAdapter.showEmailIntent;
...
public class ListWidgetView extends LinearLayout {
    ...
    private void init()
    {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.bot_list_widget_template_findly_view, this, true);
