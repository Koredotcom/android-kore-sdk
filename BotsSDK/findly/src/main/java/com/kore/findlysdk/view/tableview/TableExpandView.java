package com.kore.findlysdk.view.tableview;
...
import com.kore.findlysdk.view.tableview.colorizers.TableDataRowColorizer;
import com.kore.findlysdk.view.tableview.listeners.TableHeaderClickListener;
import com.kore.findlysdk.view.tableview.model.TableColumnModel;
import com.kore.findlysdk.view.tableview.model.TableColumnWeightModel;
import com.kore.findlysdk.view.tableview.providers.TableDataRowBackgroundProvider;
import com.kore.findlysdk.view.tableview.toolkit.TableDataRowBackgroundProviders;
    ...
    public void setHeaderVisible(boolean visible, int animationDuration) {
        if (visible && !isHeaderVisible()) {
            if (animationDuration > 0) {
                @SuppressLint("ObjectAnimatorBinding") final Animator moveInAnimator = ObjectAnimator.ofPropertyValuesHolder((Object) null, PropertyValuesHolder.ofFloat("y", 0));
            ...
            if (animationDuration > 0) {
                @SuppressLint("ObjectAnimatorBinding") final Animator moveOutAnimator = ObjectAnimator.ofPropertyValuesHolder((Object) null, PropertyValuesHolder.ofFloat("y", -tableHeaderView.getHeight()));
