package com.kore.findlysdk.websocket;

import android.content.Context;
import android.os.Handler;
import android.util.Log;

import com.kore.findlysdk.autobahn.websocket.WebSocketConnection;
import com.kore.findlysdk.autobahn.websocket.WebSocketConnectionHandler;
...
import com.kore.findlysdk.events.RTMConnectionEvent;
...
//    final RestAPI restAPI = BotRestBuilder.getBotRestService();
    private Observable<RestResponse.RTMUrl> getRtmUrl(final String accessToken, final BotInfoModel botInfoModel){
...
//                        Log.d(LOG_TAG, "onBinaryMessage payload: " + payload);
    ...
    private Observable<RestResponse.RTMUrl> getRtmUrlReconnectForAuthenticUser(final String accessToken){
