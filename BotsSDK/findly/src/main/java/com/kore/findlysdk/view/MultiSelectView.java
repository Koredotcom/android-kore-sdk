...
import com.kore.findlysdk.adapters.MultiSelectButtonAdapter;
...
public class MultiSelectView extends ViewGroup {
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.multi_select_findly_template, this, true);
