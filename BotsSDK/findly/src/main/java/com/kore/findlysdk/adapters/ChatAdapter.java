...
import com.kore.findlysdk.utils.SelectionUtils;
import com.kore.findlysdk.utils.StringUtils;
import com.kore.findlysdk.view.KaBaseBubbleFindlyContainer;
import com.kore.findlysdk.view.KaBaseBubbleFindlyLayout;
import com.kore.findlysdk.view.KaReceivedBubbleFindlyContainer;
import com.kore.findlysdk.view.KaReceivedBubbleFindlyLayout;
import com.kore.findlysdk.view.KaSendBubbleFindlyFindlyContainer;
import com.kore.findlysdk.view.KaSendBubbleFindlyLayout;
...
//    private static String LOG_TAG = ChatAdapter.class.getSimpleName();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(ownLayoutInflater.inflate( i == BUBBLE_RIGHT_LAYOUT ?  R.layout.ka_bubble_layout_findly_right : R.layout.ka_bubble_layout_findly_left, null),i);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        KaBaseBubbleFindlyContainer baseBubbleContainer;
        KaBaseBubbleFindlyLayout baseBubbleLayout;
        View headerView;
        TextView textView;
        public ViewHolder(View view,int viewType){
            ...
            if ( viewType== BUBBLE_RIGHT_LAYOUT) {
                // Right Side
                baseBubbleLayout = (KaSendBubbleFindlyLayout) view.findViewById(R.id.sendBubbleLayout);
                baseBubbleContainer = (KaSendBubbleFindlyFindlyContainer) view.findViewById(R.id.send_bubble_layout_container);
            } else {
                // Left Side
                baseBubbleLayout = (KaReceivedBubbleFindlyLayout) view.findViewById(R.id.receivedBubbleLayout);
                baseBubbleContainer = (KaReceivedBubbleFindlyContainer) view.findViewById(R.id.received_bubble_layout_container);
            }
    ...
    public void removeAllBotMessages()
    {
        baseBotMessageArrayList.removeAll(baseBotMessageArrayList);
        baseBotMessageArrayList = new ArrayList<>();
    }
