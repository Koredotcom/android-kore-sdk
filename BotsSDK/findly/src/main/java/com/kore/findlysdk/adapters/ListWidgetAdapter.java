...
import com.kore.findlysdk.listners.RecyclerViewDataAccessor;
import com.kore.findlysdk.listners.VerticalListViewActionHelper;
import com.kore.findlysdk.models.BotResponse;
import com.kore.findlysdk.models.LoginModel;
import com.kore.findlysdk.models.MultiAction;
...
import com.kore.findlysdk.view.viewHolder.EmptyWidgetViewHolder;
...
//    private Duration _cursor;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == REPORTS ){
            View view = inflater.inflate( R.layout.need_login_widget_findly_layout, parent, false);
            return new ReportsViewHolder(view);
        }
        else if (viewType == EMPTY_CARD || viewType == MESSAGE) {
            View view = inflater.inflate( R.layout.card_empty_widget_findly_layout, parent, false);
            return new EmptyWidgetViewHolder(view);
        }else
            return new ViewHolder(inflater.inflate( R.layout.listwidget_findly_view, parent, false));
    }
