...
//                ivArrow.setVisibility(View.VISIBLE);
    ...
    private void showTableViewDialog(LinearLayout.LayoutParams cellLayoutParams)
    {
        ...
        dialog.setContentView(R.layout.tableview_findly_dialog);
...
//        textView.setGravity(Gravity.CENTER);
    ...
    private View renderChildArrowView(boolean showDivider) {
        LinearLayout renderView = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.table_resp_child_arrow_findly_view, null);
