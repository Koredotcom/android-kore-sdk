...
import com.kore.findlysdk.drawables.ProfileDrawable;
import com.kore.findlysdk.utils.AppControl;
import com.kore.findlysdk.utils.StringConstants;
 ...
 */
public class CircularProfileFindlyView extends RoundedImageView {
    ...
    public CircularProfileFindlyView(Context context) {
        super(context);
        init(null, context);
    }

    public CircularProfileFindlyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, context);
    }

    public CircularProfileFindlyView(Context context, AttributeSet attrs, int defStyleAttr) {
