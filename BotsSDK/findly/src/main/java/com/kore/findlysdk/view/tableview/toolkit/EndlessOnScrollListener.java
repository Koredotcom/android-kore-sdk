package com.kore.findlysdk.view.tableview.toolkit;

import android.widget.ListView;

import com.kore.findlysdk.view.tableview.listeners.OnScrollListener;

/**
 * A {@link } that will trigger loading of further items when the end of the
 * list is reached.
 *
 * @author ISchwarz
 */
