...
import com.kore.findlysdk.formatters.BarChartDataFormatter;
import com.kore.findlysdk.models.BotBarChartDataModel;
...
public class BarChartView extends ViewGroup implements OnChartValueSelectedListener {
    ...
    private void init() {
        ...
        CustomMarkerView mv = new CustomMarkerView(mContext, R.layout.marker_findly_content);
